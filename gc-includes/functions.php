...
*  $LastChangedDate: 2007-04-29 14:18:46 +0800 (ÊòüÊúüÊó•, 29 ÂõõÊúà 2007) $
...
function processSearchForm($aFormValues)
{
	...
	if($keyword!=""){
    	...
    	$objResponse = new xajaxResponse();
    	$objResponse->addAssign("div1","innerHTML","«Î‘⁄À—À˜øÚ÷– ‰»ÎœÎ“™≤È’“µƒƒ⁄»›<br/><br/>");
	}
...
function count_total_days($echo=true){
	...
	$total_days=(int)($total_hours/24); // º¥????µƒœ‡≤ÓÃÏ?
